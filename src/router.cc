...
{
  cerr << "DEBUG: adding route " << route_prefix << " " <<  Address::from_ipv4_numeric( route_prefix ).ip() << "/"
...
std::vector<Router::router>::iterator Router::longest_prefix_match_( uint32_t dst_ip ){
